module Spree
  # 2022-03-17 : This was pulled out of the solidus-2.3 codebase 
  #
  ...
  class PaymentMethod::CreditCard < PaymentMethod
    ...
    def reusable_sources(order)
      if order.completed?
        ...
        order.user.wallet.wallet_payment_sources.map(&:payment_source).select{|source| source.payment_method_id == id && source.reusable?}
      else
        []
      end
    end
